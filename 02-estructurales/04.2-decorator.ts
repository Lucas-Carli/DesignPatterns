...
abstract class CharacterDecorator implements Character {
  ...
  // Defino la propiedad protected character de tipo Character
  protected character: Character;

  // Defino el constructor que recibe un personaje de tipo Character
  constructor(character: Character) {
    this.character = character;
  }

  // Implemento los métodos de la interfaz Character, pero retornando
