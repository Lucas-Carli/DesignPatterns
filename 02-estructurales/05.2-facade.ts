...
class ComputerFacade {
  ...
  startComputer(): void {
    ...
    // 1. Cargar el sistema operativo en la memoria -
    // 2. Saltar a la posición de memoria 0 -
    // 3. Ejecutar las instrucciones del CPU -
  ...
  shutDownComputer(): void {
    ...
    // 1. Detener las operaciones del CPU -
    // 2. Liberar la memoria -
    // 3. Cerrar el disco duro -
